...
class Ui_MainWindow(QMainWindow):
    ...
    def setup_settings(self):
        ...
        self.ledt_amount.setStatusTip(_translate("The amount of the questions", "题目总数,默认{}".format(Others.config_args[Ledt.ledt_amount])))
        self.ledt_amount.setPlaceholderText(_translate("The amount of the questions", "题目总数,默认{}".format(Others.config_args[Ledt.ledt_amount])))
        ...
        self.ledt_less_than.setStatusTip(_translate("The nums will be less than", "多少以内,默认{}".format(Others.config_args[Ledt.ledt_less_than])))
        self.ledt_less_than.setPlaceholderText(_translate("The nums will be less than", "多少以内,默认{}".format(Others.config_args[Ledt.ledt_less_than])))
        ...
        self.ledt_item_num.setStatusTip(_translate("How many items will there be in a question", "每道题目多少项,默认{}".format(Others.config_args[Ledt.ledt_item_num])))
        self.ledt_item_num.setPlaceholderText(_translate("How many items will there be in a question", "每道题目多少项,默认{}".format(Others.config_args[Ledt.ledt_item_num])))
        ...
        self.ledt_operator.setPlaceholderText(_translate("separate by ' , ' ", "英文半角逗号','分隔,默认{}".format(Others.config_args[Ledt.ledt_operator])))
        self.ledt_operator.setStatusTip(_translate("What operators will be use in the problems, separate by ','", "什么运算, 英文半角逗号分隔,默认{}".format(Others.config_args[Ledt.ledt_operator])))
        ...
        self.ledt_decimal.setPlaceholderText(_translate("How many decimals", "小数位数,默认{}".format(Others.config_args[Ledt.ledt_decimal])))
        self.ledt_decimal.setToolTip(_translate("How many decimals", "小数位数,默认{}".format(Others.config_args[Ledt.ledt_decimal])))
        self.ledt_decimal.setStatusTip(_translate("How many decimals", "小数位数,默认{}".format(Others.config_args[Ledt.ledt_decimal])))
