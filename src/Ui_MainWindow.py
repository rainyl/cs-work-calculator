...
class Ui_MainWindow(QMainWindow):
    ...
    def setup_settings(self):
        ...
        self.ledt_amount.setPlaceholderText(_translate("The amount of the questions", "题目总数，默认10"))
        ...
        self.ledt_less_than.setPlaceholderText(_translate("The nums will be less than", "多少以内，默认50"))
        ...
        self.ledt_item_num.setPlaceholderText(_translate("How many items will there be in a question", "每道题目多少项，默认50"))
        ...
        self.ledt_operator.setStatusTip(_translate("What operators will be use in the problems, separate by ','", "什么运算, 英文半角逗号分隔，默认+，-"))
        ...
        self.ledt_decimal.setPlaceholderText(_translate("How many decimals", "小数位数，默认0"))
